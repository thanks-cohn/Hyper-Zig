...
TRANSCRIPT="$ROOT/smoke/transcripts/latest-smoke-hv26-negative-invariants-v0.txt"; : > "$TRANSCRIPT"; ELF="$ROOT/zig-out/bin/zign01d-v0"
...
transcript=sys.argv[1]; cmd=sys.argv[2:]; commands=['hv guest-entry require-activation-plan-test', 'hv guest-entry require-context-test', 'hv guest-entry register-corruption-test', 'hv guest-entry guest-entered-test', 'hv guest-entry instruction-executed-test', 'hv trap-return require-entry-frame-test', 'hv trap-return require-csr-safety-test', 'hv trap-return require-hext-test', 'hv trap-return sepc-corruption-test', 'hv trap-return status-corruption-test', 'hv trap-return executed-test', 'hv first-instruction require-hgatp-test', 'hv first-instruction require-activation-plan-test', 'hv first-instruction require-entry-frame-test', 'hv first-instruction require-trap-return-frame-test', 'hv first-instruction guest-entered-test', 'hv first-instruction instruction-executed-test', 'hv first-instruction trap-return-executed-test', 'hv first-instruction active-stage2-test', 'hv first-instruction hgatp-written-test', 'hv hv26 invariant-all', 'shutdown']
...
for n in ['activation-plan-missing', 'guest-context-missing', 'register-corrupt', 'guest-entered-forbidden', 'instruction-executed-forbidden', 'entry-frame-missing', 'csr-safety-missing', 'h-extension-missing', 'sepc-corrupt', 'status-corrupt', 'trap-return-executed-forbidden', 'hgatp-missing', 'trap-return-frame-missing', 'active-stage2-forbidden', 'hgatp-written-forbidden', 'hv26.all_invariants=ok']:
...
print('PASS smoke-hv26-negative-invariants-v0.sh')
PYCHECK
