...
need(5,'hv: sbi_dispatch.console_getchar_test=ok'); need(5,'hv: sbi_dispatch.last_target=console-getchar'); need(5,'hv: sbi_dispatch.getchar_result=no-input'); need(5,'hv: console_getchar=no-input'); assert num(5,'hv: sbi_dispatch.console_dispatch_count=') == 2; assert num(5,'hv: console.input_unavailable_count=') == 1
