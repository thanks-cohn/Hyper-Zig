...
need(8, "hv second-stage alignment-test", "hv: second_stage.alignment_test.stage_error=misaligned")
...
need(11, "hv exec", "hv: guest_exec.non_claim.guest_instruction_execution=false")
