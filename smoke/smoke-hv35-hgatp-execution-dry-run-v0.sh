...
for m in ['executor_entered=true','executor_returned=true','execute_count=1','execution_policy_allows=false','execution_policy_denies=true','execution_denied_before_csr=true','execution_blocked_before_raw_write=true','execution_reached_raw_write=false','execution_called_raw_write=false','execution_returned_from_raw_write=false','raw_write_function_known=true','raw_write_function_allowed=false','raw_write_function_called=false','hgatp_write_attempted=false','hgatp_write_performed=false','active_stage2=false','guest_entered=false','first_guest_instruction_executed=false']:
 assert 'hv: hgatp_execution_dry_run.'+m in blocks[30], m
for m in ['step_source_loaded=true','step_preflight_checked=true','step_policy_checked=true','step_opt_in_checked=true','step_denied_before_csr=true','step_blocked_before_raw_write=true','step_raw_write_skipped=true','step_result_recorded=true','step_safe_return_recorded=true']:
 assert 'hv: hgatp_execution_dry_run.'+m in blocks[31], m
