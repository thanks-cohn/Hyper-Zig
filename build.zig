...
const hyperzig_status_text =
    ...
    \\  Zig target: 0.14.x
    \\  current proven milestones: HV0 through HV19 when smoke validation passes
    \\  current milestone: HV19 SBI Console Mediation Foundation (no Linux boot or printk claim)
