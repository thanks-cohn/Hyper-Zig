...
const hyperzig_status_text =
    ...
    \\  Zig target: 0.14.x
    \\  current proven milestones: HV0, HV1, HV2, HV3, HV4, HV5, HV6, HV7, HV8, HV9, HV10 when smoke validation passes
    \\  next milestone: HV11 continue hardware-gated guest execution research (no Linux claim)
    ...
    \\  VM/vCPU model, vCPU lifecycle, guest-memory object, guest-address-space metadata, tiny-flat-v0 guest-image loader, guest-entry preparation, guest trap/exit metadata, controlled guest-run attempt safety gate, and hardware-gated execution preparation implemented and smoke-proven when validation passes
