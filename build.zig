...
const hyperzig_status_text =
    ...
    \\  Zig target: 0.14.x
    \\  current proven milestones: HV0, HV1, HV2, HV3, HV4, HV5, HV6, HV7, HV8, HV9, HV10, HV11, HV12, HV13 when smoke validation passes
    \\  next milestone: HV14 safe hardware H-extension proof and HGATP-readiness research (no Linux claim)
    ...
    \\  no active second-stage translation yet; HV11 models metadata, HV12 builds a software-only page-table-like structure, and HV13 plans guarded activation readiness without writing HGATP
    \\  VM/vCPU model, vCPU lifecycle, guest-memory object, guest-address-space metadata, tiny-flat-v0 guest-image loader, guest-entry preparation, guest trap/exit metadata, controlled guest-run attempt safety gate, hardware-gated execution preparation, and second-stage translation metadata, the software-only stage2 table builder, and guarded stage2 activation readiness implemented and smoke-proven when validation passes
