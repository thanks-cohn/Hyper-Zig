...
const hyperzig_status_text =
    ...
    \\  Zig target: 0.14.x
    \\  current proven milestones: HV0 through HV15 when smoke validation passes
    \\  next milestone: HV16 virtual timer/SBI mediation prerequisites (no Linux claim)
